...
////            "cloud_name", "dvxnedfzr",   // <-- your cloud name
////            "api_key", "364824236577635",       // NOT USED in unsigned mode (keep dummy)
////            "api_secret", "6T5CVEfLnXBFuQ-l4X5abjTSrIQ"       // NOT USED in unsigned mode
////    ));
//
//    String uploadPreset = "samparka_unsigned"; // <-- UPDATE with your preset name
//
//    @Override
